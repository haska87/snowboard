            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
              ...
              <div className="space-y-6">
                  ...
                  <ol className="list-decimal list-inside text-gray-700 space-y-4">
                    ...
                    <li>
                      ...
                      <ul className="list-disc list-inside pl-6 mt-3 space-y-2 text-gray-600">
                        ...
                        <li>Рост 175 см ближе к середине диапазона, поэтому берем длину ближе к середине между 149 и 161 см.</li>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700 font-medium">Рекомендуемая длина сноуборда — 156 см.</p>
                </div>
              </div>
            </div>
          </section>
